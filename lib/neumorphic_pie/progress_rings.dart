...
class ProgressRings extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    //num gradientStartAngle=(2 * pi * (completedPercentage!))+10;
    //num gradientEndAngle=(2 * pi * (completedPercentage!))-10;
    ...
    canvas.drawArc(
      ...
      paint(
        gradient!,
        startAngle: gradientStartAngle*1,
        endAngle: gradientEndAngle*1,
      ),
    );
  }
